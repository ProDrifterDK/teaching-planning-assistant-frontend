...
"Analizando el Objetivo de Aprendizaje (OA) para extraer sus verbos y conceptos clave...",
  ...
  "Estructurando la secuencia didáctica: Inicio, Desarrollo y Cierre...",
  "Diseñando una actividad de inicio que active los conocimientos previos...",
  "Creando el núcleo de la clase con una actividad principal que fomente la colaboración...",
  "Integrando momentos clave para la evaluación formativa y el feedback constructivo...",
  "Planificando una actividad de cierre que permita la reflexión y la metacognición...",
  "Ajustando los tiempos estimados para cada etapa, dejando espacio para la flexibilidad...",
  "Considerando la diversidad en el aula y diseñando apoyos para necesidades especiales...",
  "Alineando la evaluación con el Objetivo de Aprendizaje y los indicadores de logro...",
  "Redactando instrucciones claras y concisas para cada actividad propuesta...",
  "Verificando que la planificación promueva un clima de aula positivo y participativo...",
  "Seleccionando preguntas clave para guiar la discusión y el pensamiento crítico...",
  "¡Casi listo! Dando los toques finales para asegurar una experiencia de aprendizaje coherente...",
  "Revisando la ortografía, gramática y formato del documento final...",
  "Asegurando que todos los materiales y recursos estén listos y accesibles...",
  "Simulando mentalmente el flujo de la clase para anticipar posibles desafíos...",
  "Añadiendo una nota para el docente con sugerencias de gestión del aula...",
  "Generando la estructura final del documento en formato Markdown...",
  "Compilando todas las ideas en una secuencia lógica y fácil de seguir...",
  "Optimizando la carga cognitiva de las actividades para evitar la sobrecarga...",
  "Pensando en cómo conectar el contenido con las experiencias de los estudiantes...",
  "Incorporando elementos lúdicos o de gamificación para aumentar la motivación...",
  "Diseñando la estrategia de agrupación de los estudiantes para el trabajo colaborativo...",
  "Definiendo los criterios de éxito de la actividad principal...",
  "Creando un ticket de salida o una pregunta de cierre para evaluar la comprensión...",
